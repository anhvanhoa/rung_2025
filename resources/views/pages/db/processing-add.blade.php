            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        <form action="{{ route('db.processing.post-add') }}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select style="height: 40px;" required class="form-control sumoSelect" id="business_form" multiple
                                            name="business_form[]">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" name="workers_deg" autocomplete="off"
                                            placeholder="Nhập số nhân công" value="{{ old('workers_deg') }}">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" name="workers_no_qual" autocomplete="off"
                                            placeholder="Nhập số nhân công" value="{{ old('workers_no_qual') }}">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">

            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        <form action="{{ route('db.breed.post-add') }}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input required class="form-control" type="text" name="name" autocomplete="off"
                                            placeholder="Tên người đại diện" value="{{ old('name') }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select required class="form-control sumoSelect" id="business_type"
                                            ...
                                            @foreach ($businessTypes as $bt)
                                                <option value="{{ $bt->id }}" @if ($bt->id == old('business_type')) selected
                                                @endif>
                                                    {{ $bt->name }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select style="height: 40px;" required class="form-control sumoSelect"
                                            ...
                                            @foreach ($businessForms as $bf)
                                                <option value="{{ $bf->id }}" @if ($bf->id == old('business_form')) selected
                                                @endif>
                                                    {{ $bf->name }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select required class="form-control sumoSelect" id="district" name="district">
                                            @foreach ($districts as $d)
                                                <option value="{{ $d->code }}" @if ($d->code == old('district')) selected @endif>
                                                    {{ $d->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" name="female_workers" autocomplete="off"
                                            placeholder="Nhập số nhân công" value="{{ old('female_workers') }}">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" name="male_workers" autocomplete="off"
                                            placeholder="Nhập số nhân công" value="{{ old('male_workers') }}">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input required class="form-control" type="number" name="annual_revenue" autocomplete="off"
                                            placeholder="Nhập doanh thu" value="{{ old('annual_revenue') }}">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col">
                                            ...
                                            <select required style="height: 40px;" class="form-control sumoSelect"
                                                ...
                                                <option value="fixed" @if (old('irrigation_type') == 'fixed') selected @endif>
                                                    Cố định
                                                </option>
                                                <option value="dynamic" @if (old('irrigation_type') == 'dynamic') selected
                                                @endif>
                                                    Linh động
                                                </option>
                                            </select>

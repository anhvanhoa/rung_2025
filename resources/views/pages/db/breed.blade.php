                        ...
                        <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                            ...
                            <div class="col-auto dropstart">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{route('db.breed.export-excel')}}">Xuất excel</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{route('db.breed.export-pdf')}}">Xuất PDF</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        const loadData = async (param = {}) => {
            const response = await getData('GET', '{{ route('db.breed-data') }}', param,
                @json(csrf_token()));
            return response;
        }

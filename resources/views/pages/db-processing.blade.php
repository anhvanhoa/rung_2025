...
@section('content')
    <div class="pb-8">
        <h1 class="text-2xl">Chế biến gỗ</h1>
    </div>
            ...
            <tr>
                <th>
                    <span class="flex items-center">
                        Company Name
                        <i data-lucide="chevrons-up-down" class="ml-1 size-3.5"></i>
                    </span>
                </th>
                <th>
                    <span class="flex items-center">
...
@section('js')
    <script>
        if (document.getElementById("search-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#search-table", {
                ...
                labels: {
                    ...
                    perPage: "trong 1 trang",
                    noRows: "Không có dữ liệu nào",
                    info: "Đang hiển thị {start} đến {end} của {rows} mục",
                },
            });
        }
        ...
        //     setTimeout(() => {
        //         document.querySelectorAll(".datatable-pagination a").forEach((btn) => {
        //             if (btn.getAttribute("data-page") == dataTable.page()) {
        //                 btn.classList.add("text-red-500"); // Thêm active vào trang hiện tại
        //             }
        //         });
        //     }, 100); // Delay để đợi UI cập nhật
        // }

        // highlightActivePage(); // Chạy khi load trang lần đầu

        // document.querySelector("#search-table").addEventListener("datatable.page", function () {
        //     highlightActivePage();
        // });
    </script>
@endsection
